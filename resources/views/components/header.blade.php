    ...
    <div class="row no-gutters">
        <div class="col-md-12">
            <nav class="nav nav-justified main-nav">
                <a class="nav-item py-3 ls-2 border border-dark nav-link" href="#">{{ __('header.oa') }}</a>
                <a class="nav-item py-3 ls-2 border border-dark text-uppercase nav-link" href="#">{{ __('header.architects') }}</a>
                <a class="nav-item py-3 ls-2 border border-dark text-uppercase nav-link" href="#">{{ __('header.objects') }}</a>
                <a class="nav-item py-3 ls-2 border border-dark text-uppercase nav-link" href="#">{{ __('header.collections') }}</a>
            </nav>
        </div>
    </div>
    <div class="row no-gutters">
