...
class FillPermissionsForArchitect extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForArchitect constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.architect',
            'admin.architect.index',
            'admin.architect.create',
            'admin.architect.show',
            'admin.architect.edit',
            'admin.architect.delete',
            'admin.architect.bulk-delete',
        ]);
